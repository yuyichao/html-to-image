...
function encodeSvg(svg, plain = false) {
    return __awaiter(this, void 0, void 0, function* () {
        const res = Promise.resolve().then(() => new XMLSerializer().serializeToString(svg));
        if (plain)
            return res;
        return res
...
export function nodeToDataURL(node, width, height, options = {}) {
    return __awaiter(this, void 0, void 0, function* () {
